...
<head>
    ...
    <link href="/tp/Application/Admin/Public/css/datepicker3.css" rel="stylesheet">
    <link href="/tp/Application/Admin/Public/css/styles.css" rel="stylesheet">

    <!--[if lt IE 9]>
    <script src="/tp/Application/Admin/Public/js/html5shiv.js"></script>
    <script src="/tp/Application/Admin/Public/js/respond.min.js"></script>
    <![endif]-->
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><span>博客</span>管理</a>
            <ul class="user-menu">
                <li class="dropdown pull-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="glyphicon glyphicon-user"></span> <?php echo $userInfo['nikename']?>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a href="/tp/index.php/Admin/Index/logout">
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <!--<li>
            <a href="login.html">
                <span class="glyphicon glyphicon-user"></span> Login Page
            </a>
        </li>-->
    </ul>
</div><!--/.sidebar-->
...
<script src="/tp/Application/Admin/Public/js/jquery-1.11.1.min.js"></script>
<script src="/tp/Application/Admin/Public/js/bootstrap.min.js"></script>
<script src="/tp/Application/Admin/Public/js/chart.min.js"></script>
<script src="/tp/Application/Admin/Public/js/chart-data.js"></script>
<script src="/tp/Application/Admin/Public/js/easypiechart.js"></script>
<script src="/tp/Application/Admin/Public/js/easypiechart-data.js"></script>
<script src="/tp/Application/Admin/Public/js/bootstrap-datepicker.js"></script>
<script>
    $('#calendar').datepicker({});
