...
<head>
    ...
    <link rel="stylesheet" href="/tp/Public/css/style.css"/>
    <script type="text/javascript" src="/tp/Public/js/jquery1.42.min.js"></script>
    <script type="text/javascript" src="/tp/Public/js/jquery.SuperSlide.2.1.1.js"></script>
    <!--[if lt IE 9]>
    <script src="/tp/Public/js/html5.js"></script>
    <![endif]-->
</head>
...
<div id="content">
    ...
    <div class="left" id="c_left">
        ...
        <div class="content_text">
            ...
            <div class="wz">
                ...
                <dl>
                    <dt>
                        <img src="<?php echo $public ?>images/s.jpg" width="200" height="123" alt="">
                    </dt>
                    <dd>
                        <p class="dd_text_1">
                        ...
                        <p class="dd_text_2">
                            ...
                            <span class="left sj">时间:2014-8-9</span>
                            <span class="left fl">
                                分类:
            ...
            <div class="wz">
                ...
                <dl>
                    <dt>
                        <img src="<?php echo $public ?>images/s1.jpg" width="200" height="123" alt="">
                    </dt>
                    <dd>
                        <p class="dd_text_1">
                            最近看群里聊天聊得最火热的莫过于手机网站和html5这两个词。可能有人会问，这两者有什么关系呢？随着这移动互联
            ...
            <div class="wz">
                ...
                <dl>
                    <dt>
                        <img src="<?php echo $public ?>images/s2.jpg" width="200" height="123" alt="">
                    </dt>
                    <dd>
                        <p class="dd_text_1">
                            最近看群里聊天聊得最火热的莫过于手机网站和html5这两个词。可能有人会问，这两者有什么关系呢？随着这移动互联
            ...
            <div class="wz">
                ...
                <dl>
                    <dt>
                        <img src="<?php echo $public ?>images/s3.jpg" width="200" height="123" alt="">
                    </dt>
                    <dd>
                        <p class="dd_text_1">
                            最近看群里聊天聊得最火热的莫过于手机网站和html5这两个词。可能有人会问，这两者有什么关系呢？随着这移动互联
            ...
            <div class="wz">
                ...
                <dl>
                    <dt>
                        <img src="<?php echo $public ?>images/s4.jpg" width="200" height="123" alt="">
                    </dt>
                    <dd>
                        <p class="dd_text_1">
                            最近看群里聊天聊得最火热的莫过于手机网站和html5这两个词。可能有人会问，这两者有什么关系呢？随着这移动互联
    ...
    <div class="right" id="c_right">
        <div class="s_about">
            <h2>关于博主</h2>
            <img src="<?php echo $public ?>images/my.jpg" width="230" height="230" alt="博主"/>
            <p>博主：XX</p>
            <p>职业：web前端、视觉设计</p>
            <p>简介：</p>
            <p>
...
<script type="text/javascript" src="/tp/Public/js/nav.js"></script>
